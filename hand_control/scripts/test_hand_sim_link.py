...
from hand_control.hand_sim_link import RevoHandSimLink, real_hand_joint_names, real_hand_actuator_names

SIDE = "left"
MODEL_PATH = os.path.join(os.path.dirname(__file__), "..", "config", "revo2_hand_real", f"{SIDE}_hand.xml")
